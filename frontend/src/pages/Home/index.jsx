...
const Home = () => {
    ...
    useEffect(() => { console.log("make bet chamado"); makeBet?.()}, [betSide])
    useEffect(() => { console.log("validate chamado"); subscribeAsValidator?.()}, [validationSide])
